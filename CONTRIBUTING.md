...
3. Ejecute `devtools::document()` y `devtools::check()`.
4. No incluya tokens, correos privados ni archivos `.Renviron` en los commits.
5. Abra un *pull request* explicando el problema y la solución.
